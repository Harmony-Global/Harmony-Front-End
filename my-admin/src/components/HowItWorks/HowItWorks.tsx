    ...
    <section className="how-it-works-section">
      ...
      <div className="steps-container">
        ...
        <div className="step-card">
          ...
          <div className="step-image-wrapper">
            <div className="step-image-card">
              <img src="../../../src/assets/HIW1.png" alt="Step 1" />
        ...
        <div className="step-card">
          <div className="step-image-wrapper">
            <div className="step-image-card">
              <img src="../../../src/assets/HIW2.png" alt="Create Your Profile" />
              <div className="step-label">
        ...
        <div className="step-card">
          ...
          <div className="step-image-wrapper">
            <div className="step-image-card">
              <img src="../../../src/assets/HIW3.png" alt="Discover & Connect" />
              <div className="step-label">
        ...
        <div className="step-card">
          <div className="step-image-wrapper">
            <div className="step-image-card">
              <img src="../../../src/assets/HIW4.png" alt="Work & Grow Together" />
              <div className="step-label">
